...
import static mushirih.pickup.cm.CommonUtilities.SERVER_URL;
import static mushirih.pickup.cm.CommonUtilities.TAG;
...
public class ServerUtilities {
    ...
    private static void post(String serverUrl, final Map<String, String> params) {
        StringRequest strReqXSI = new StringRequest(Request.Method.POST,
        ...
        MyApplication.getInstance().addToRequestQueue(strReqXSI);
    }
