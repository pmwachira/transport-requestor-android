...
public class FetchAddressIntentService extends IntentService {
           ...
           // Log.e(TAG, errorMessage, ioException);
            //TODO REMOVE THIS IF DOESNT WORK
                ...
                try
                {
                    ...
                    if (cityName != null)
                    {
                        deliverResultToReceiverSecond(AppUtils.LocationConstants.SUCCESS_RESULT, cityName);
                    }else{
    ...
    private void deliverResultToReceiverSecond(int successResult, String cityName) {
        try {
            Bundle bundle = new Bundle();
            bundle.putString(AppUtils.LocationConstants.RESULT_DATA_KEY, cityName);
